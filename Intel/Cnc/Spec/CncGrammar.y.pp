...
--  | Mods tags '<' Type '>' var             { [DeclareTags (lexSpan $2) (lexStr $6) (Just $4)] }
  ...
  | tags '<' Type '>' var                  { [DeclareTags LL (tAL $5) (Just $3)] }
...
-- are accepted and an error is thrown if the wrong number are present:
...
#ifdef LEGACY_SYNTAX
  | '<' Type var '>'                       { [DeclareTags LL (tAL $3) (Just $2)] }
  ...
  | '<' Type var ':' VarsOnlyHack '>'      { [DeclareTags LL (tAL $3) (Just $2)] }

  | '[' Type var '<' Type '>' ':' TagExps ']' { [DeclareItems LL (tAL $3) (Just ($5, $2))] }
  | '[' Type var '<' Type '>' ']'             { [DeclareItems LL (tAL $3) (Just ($5, $2))] }
#endif
...
Exp : var	             	{ Var (lexSpan $1) (tAL $1) }
    ...
    | Exp op Exp	        { App (combExpSpans $1 $3) (Var DD (tAL $2)) [$1, $3] } 
